    ...
    <DashboardLayout>
      <main className="flex-1 max-w-[800px] mx-auto w-full p-6 lg:p-10 space-y-10">
        ...
        <div className="space-y-6">
          <section className="bg-white dark:bg-slate-900/50 p-6 lg:p-8 rounded-2xl shadow-sm border border-slate-200 dark:border-slate-800 space-y-6">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center gap-6 pb-6 border-b border-slate-100 dark:border-slate-800/60">
              <div className="size-20 rounded-full bg-slate-100 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 flex items-center justify-center shrink-0 overflow-hidden relative group">
              ...
              <div>
                <button className="px-4 py-2 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl text-sm font-medium hover:bg-slate-50 dark:hover:bg-slate-700 transition-colors shadow-sm mb-2 text-slate-700 dark:text-slate-300">
                  Change Avatar
                </button>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
              <div className="space-y-2">
                ...
                <input type="text" defaultValue="John" className="w-full px-4 border border-slate-200 dark:border-slate-700 rounded-xl focus:ring-2 focus:ring-primary/20 focus:border-primary py-2.5 text-sm bg-slate-50 dark:bg-slate-800/50 outline-none transition-all dark:text-white" />
              </div>
              <div className="space-y-2">
                <label className="text-sm font-medium text-slate-700 dark:text-slate-300">Last Name</label>
                <input type="text" defaultValue="Doe" className="w-full px-4 border border-slate-200 dark:border-slate-700 rounded-xl focus:ring-2 focus:ring-primary/20 focus:border-primary py-2.5 text-sm bg-slate-50 dark:bg-slate-800/50 outline-none transition-all dark:text-white" />
              </div>
              <div className="md:col-span-2 space-y-2">
                <label className="text-sm font-medium text-slate-700 dark:text-slate-300">Email Address</label>
                <input type="email" defaultValue="hello@johndoe.com" className="w-full px-4 border border-slate-200 dark:border-slate-700 rounded-xl focus:ring-2 focus:ring-primary/20 focus:border-primary py-2.5 text-sm bg-slate-50 dark:bg-slate-800/50 outline-none transition-all dark:text-white" />
              </div>
            </div>
          </section>
            ...
            <div className="space-y-2">
              ...
              <div className="flex flex-col sm:flex-row sm:items-center justify-between py-4 border-b border-slate-100 dark:border-slate-800/60 gap-4">
                ...
                <button 
                  ...
                  className={`relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2 dark:focus:ring-offset-slate-900 ${marketingEmails ? 'bg-green-500' : 'bg-slate-200 dark:bg-slate-700'}`}
                >
        ...
        <div className="flex justify-end gap-3 pt-6 pb-12">
          <button className="px-5 py-2.5 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl text-sm font-medium text-slate-700 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-slate-700 transition-colors shadow-sm">
            Cancel
          </button>
          <button className="px-5 py-2.5 bg-primary text-white rounded-xl text-sm font-medium hover:bg-primary/90 transition-all shadow-sm active:scale-95">
            Save Changes
          </button>
        </div>
      </main>
