    ...
    <>
      <main className="app-main flex-1">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 mb-6">
          <div className="surface-featured p-4 relative overflow-hidden">
            <p className="text-[11px] font-semibold text-featured-text/40 tracking-wider uppercase mb-2.5">Total Payables</p>
          ...
          <div className="surface-card p-4">
            <p className="text-[11px] font-semibold text-muted tracking-wider uppercase mb-2.5">Paid</p>
          ...
          <div className="surface-card p-4">
            <p className="text-[11px] font-semibold text-muted tracking-wider uppercase mb-2.5">Pending</p>
            <p className="text-xl font-semibold text-foreground font-display"><AnimatedNumber value={formatCurrency(totals.pendingAmount, currency)} /></p>
          </div>
          <div className="surface-card p-4">
            <p className="text-[11px] font-semibold text-muted tracking-wider uppercase mb-2.5">Overdue</p>
            <p className="text-xl font-semibold text-foreground font-display"><AnimatedNumber value={formatCurrency(totals.overdueAmount, currency)} /></p>
          </div>
        </div>
        ...
        <div className="space-y-2">
          {filteredInvoices.map((invoice) => (
            ...
            <button
              ...
              className="surface-card w-full text-left p-4 lg:p-5 hover:border-foreground/12 transition-smooth group"
            >
              <div className="flex items-center gap-4">
                ...
                <div className="flex-1 min-w-0">
                  <h3 className="font-semibold text-[14px] text-foreground group-hover:text-accent transition-smooth truncate">{invoice.vendor}</h3>
                ...
                <div className="text-right hidden sm:block">
                  <p className="text-lg font-semibold text-foreground font-display"><AnimatedNumber value={formatCurrency(getOutsourcingInvoiceTotal(invoice), currency)} /></p>
                ...
                <div className="hidden sm:flex gap-0.5 shrink-0 lg:opacity-0 lg:group-hover:opacity-100 transition-opacity">
                  ...
                  <span onClick={(event) => { event.stopPropagation(); handleExportOutsourcingInvoice(invoice); }} className="size-8 flex items-center justify-center rounded-full text-foreground/25 hover:text-accent hover:bg-accent/10 transition-smooth" title="Download">
              ...
              <div className="flex items-center justify-between mt-3 sm:hidden">
                <p className="text-base font-semibold text-foreground font-display"><AnimatedNumber value={formatCurrency(getOutsourcingInvoiceTotal(invoice), currency)} /></p>
          ...
          {filteredInvoices.length === 0 && (
            <div className="text-center py-16">
              <span className="material-symbols-outlined text-[42px] text-foreground/10 mb-3 block">engineering</span>
              <AnimatedText as="p" text="No outsourcing invoices yet" effect="per-word-crossfade" className="text-[13px] text-muted font-medium" />
            </div>
          )}
        </div>
      </main>
      ...
      {modalMode && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
          <button aria-label="Close modal" className="absolute inset-0 bg-foreground/25 backdrop-blur-sm" onClick={closeModal} />
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                    ...
                    return (
                      <button
                        ...
                        className={`surface-card p-4 text-left transition-smooth ${
                          isSelected ? "border-accent/55 shadow-[0_0_0_3px_color-mix(in_srgb,var(--accent)_13%,transparent)]" : "hover:border-foreground/15"
                        }`}
                      >
                        <span className="flex items-center justify-between gap-3">
                          <span>
                            <span className="block text-[13px] font-semibold text-foreground">{template.name}</span>
                            <span className="block mt-1 text-[11px] text-muted">{template.description}</span>
                          </span>
                ...
                <div className="surface-card p-4 space-y-4">
                  <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                    <div>
                      <p className="text-[11px] font-semibold text-muted tracking-wider uppercase">Vendor</p>
                      <p className="text-[11px] text-muted mt-0.5">Select a saved vendor or enter a one-time payee.</p>
                    </div>
                    <div className="grid grid-cols-2 gap-1 rounded-full border border-card-border bg-foreground/[0.04] p-1">
                      <button
                        type="button"
                  ...
                  {form.vendorMode === "saved" && vendors.length > 0 ? (
                    <div className="space-y-1.5">
                      <label className="text-[11px] font-semibold text-muted tracking-wider uppercase" htmlFor="saved-vendor">Saved Vendor</label>
                      ...
                      <div className="mt-3 flex items-start gap-3 rounded-xl border border-card-border bg-foreground/[0.03] p-3">
                        {form.avatar ? (
                          <img className="size-10 rounded-xl object-cover border border-card-border" alt={form.vendor} src={form.avatar} />
                        ) : (
                          <span className="size-10 rounded-xl bg-foreground/[0.04] flex items-center justify-center">
                            <span className="material-symbols-outlined text-[16px] text-muted">engineering</span>
                          </span>
                        )}
                        <div className="min-w-0 text-[12px] text-muted">
                          <p className="font-semibold text-foreground truncate">{form.vendor}</p>
                    ...
                    <div className="space-y-4">
                      <div className="flex items-center gap-3">
                        <div className="size-12 rounded-xl border border-card-border overflow-hidden bg-foreground/[0.03] flex items-center justify-center shrink-0">
                          {form.avatar ? (
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div className="space-y-1.5">
                          <label className="text-[11px] font-semibold text-muted tracking-wider uppercase" htmlFor="outsourcing-vendor">Vendor Name</label>
                        ...
                        <div className="space-y-1.5">
                          <label className="text-[11px] font-semibold text-muted tracking-wider uppercase" htmlFor="outsourcing-company">Company</label>
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div className="space-y-1.5">
                          <label className="text-[11px] font-semibold text-muted tracking-wider uppercase" htmlFor="outsourcing-email">Email</label>
                        ...
                        <div className="space-y-1.5">
                          <label className="text-[11px] font-semibold text-muted tracking-wider uppercase" htmlFor="outsourcing-phone">Phone</label>
                      ...
                      <div className="space-y-1.5">
                        <label className="text-[11px] font-semibold text-muted tracking-wider uppercase" htmlFor="outsourcing-address">Address</label>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                  <div className="space-y-1.5">
                    <label className="text-[11px] font-semibold text-muted tracking-wider uppercase" htmlFor="outsourcing-date">Date</label>
                  ...
                  <div className="space-y-1.5">
                    <label className="text-[11px] font-semibold text-muted tracking-wider uppercase" htmlFor="outsourcing-due-date">Due Date</label>
                  ...
                  <div className="space-y-1.5">
                    <label className="text-[11px] font-semibold text-muted tracking-wider uppercase" htmlFor="outsourcing-status">Status</label>
                    <select
                ...
                <div className="surface-card overflow-hidden">
                  <div className="flex items-center justify-between px-4 py-3 border-b border-card-border">
                    <p className="text-[11px] font-semibold text-muted tracking-wider uppercase">Payable Items</p>
                  ...
                  <div className="divide-y divide-card-border">
                    {form.items.map((item, index) => (
                      <div key={item.id} className="grid grid-cols-1 md:grid-cols-[1fr_90px_130px_40px] gap-3 p-4">
                        <div className="space-y-1.5">
                          <label className="text-[10px] font-semibold text-muted tracking-wider uppercase" htmlFor={`outsourcing-item-description-${item.id}`}>Work Purchased</label>
                        ...
                        <div className="space-y-1.5">
                          <label className="text-[10px] font-semibold text-muted tracking-wider uppercase" htmlFor={`outsourcing-item-quantity-${item.id}`}>Qty</label>
                        ...
                        <div className="space-y-1.5">
                          <label className="text-[10px] font-semibold text-muted tracking-wider uppercase" htmlFor={`outsourcing-item-price-${item.id}`}>Price</label>
                        ...
                        <div className="flex md:items-end">
                          <button type="button" onClick={() => removeItem(index)} className="size-9 flex items-center justify-center rounded-full text-muted hover:text-accent hover:bg-accent/10 transition-smooth" aria-label="Remove item">
                  ...
                  <div className="flex items-center justify-between gap-3 px-4 py-4 bg-foreground/[0.03]">
                    <span className="text-[12px] font-semibold text-muted tracking-wider uppercase">Total Payable</span>
                    <span className="text-2xl font-semibold text-foreground font-display"><AnimatedNumber value={formatCurrency(invoiceTotal, currency)} /></span>
                  </div>
                </div>
                ...
                {needsVendorSaveChoice && (
                  <div className="rounded-xl border border-accent/25 bg-accent/10 p-4">
                    <p className="text-[13px] font-semibold text-foreground mb-1">Save this vendor?</p>
                    <p className="text-[12px] text-muted mb-3">Regular vendors are available next time. One-time vendors stay only on this payable invoice.</p>
              ...
              <div className="space-y-5">
                <div className="surface-card p-5">
                  <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-5 border-b border-card-border pb-5 mb-5">
                    <div>
                      <p className="text-[11px] font-semibold text-muted tracking-wider uppercase">{selectedInvoice.templateName || "Outsourcing Invoice"}</p>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-5">
                    <div>
                      <p className="text-[10px] font-semibold text-muted tracking-widest uppercase mb-2">Pay To</p>
                      <div className="flex items-start gap-3">
                        <img className="size-10 rounded-xl object-cover border border-card-border" alt={selectedInvoice.vendor} src={selectedInvoice.avatar} />
                        <div>
                          <p className="text-[14px] font-semibold text-foreground">{selectedInvoice.vendor}</p>
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      ...
                      <div className="surface-card p-3.5">
                        <p className="text-[10px] font-semibold text-muted tracking-widest uppercase mb-1.5">Due</p>
                        <p className="text-[13px] font-semibold text-foreground">{selectedInvoice.dueDate || "No due date"}</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="overflow-hidden rounded-xl border border-card-border">
                    ...
                    {(selectedInvoice.items || []).map((item) => (
                      <div key={item.id} className="grid grid-cols-[1fr_70px_110px] gap-3 border-t border-card-border px-4 py-3 text-[13px]">
                        ...
                        <span className="text-right font-semibold text-foreground"><AnimatedNumber value={formatCurrency(item.quantity * item.price, currency)} /></span>
                      </div>
                    ))}
                    <div className="flex items-center justify-between border-t border-card-border px-4 py-4">
                      <span className="text-[12px] font-semibold text-muted tracking-wider uppercase">Total Payable</span>
                      <span className="text-2xl font-semibold text-foreground font-display"><AnimatedNumber value={formatCurrency(getOutsourcingInvoiceTotal(selectedInvoice), currency)} /></span>
                    </div>
                  </div>
                </div>
