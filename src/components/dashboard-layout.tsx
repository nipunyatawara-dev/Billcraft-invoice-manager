        ...
        >
          <div className="w-[260px] flex flex-col h-full shrink-0">
            <nav className="flex-1 p-4 overflow-y-auto space-y-1">
              <Link href="/" className={`w-full flex items-center gap-3 px-3 py-2.5 font-medium rounded-xl transition-all ${pathname === '/' ? 'bg-primary/10 text-primary dark:bg-primary/20' : 'text-slate-600 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-800/50 hover:text-slate-900 dark:hover:text-slate-100'}`}>
                <span className="material-symbols-outlined text-lg">dashboard</span>
                Dashboard
              </Link>
              <Link href="/invoices" className={`w-full flex items-center gap-3 px-3 py-2.5 font-medium rounded-xl transition-all ${pathname === '/invoices' ? 'bg-primary/10 text-primary dark:bg-primary/20' : 'text-slate-600 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-800/50 hover:text-slate-900 dark:hover:text-slate-100'}`}>
            ...
            <div className="p-4 border-t border-slate-200 dark:border-slate-800 space-y-1 bg-transparent shrink-0">
              <Link href="/settings" className={`w-full flex items-center gap-3 px-3 py-2.5 font-medium rounded-xl transition-all ${pathname === '/settings' ? 'bg-primary/10 text-primary dark:bg-primary/20' : 'text-slate-600 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-800/50 hover:text-slate-900 dark:hover:text-slate-100'}`}>
